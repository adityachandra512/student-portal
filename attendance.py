...
class Attandance:
    def __init__(self, root):
        ...
        AttandanceID_entry = ttk.Entry(left_inside_frame,textvariable=self.var_atten_id, width=20, font=("Times New Roman", 12, "bold"))
        ...
        atten_entry = ttk.Entry(left_inside_frame,textvariable=self.var_atten_roll, width=20, font=("Times New Roman", 12, "bold"))
    ...
    def exportCsv(self):
        try:
            if len(mydata)<1:
                messagebox.showerror("NO data","N0 Data Found",parent=self.root)
                return False
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.showinfo("Dtata Export","your data has been exported"+os.path.basename(fln)+"Successfully")
