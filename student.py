...
class Student:
    def __init__(self, root):
        ...
        self.var_photo = StringVar(value="No")  # Default to "No" for photo sample
        ...
        class_div_combo["value"] = ("First", "Second", "Third","Forth","Fifth","Sixth","Seventh","Eighth","Ninth","Tenth","Eleventh","twelfth")
        ...
        #take photo button
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",font=("Times New Roman", 12, "bold"), bg="blue",fg="white",width=39)
        take_photo_btn.grid(row=0,column=0)

        #update photo button
        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",font=("Times New Roman", 12, "bold"), bg="blue",fg="white",width=39)
        ...
        img_right = Image.open(r"C:\Users\adity\Downloads\face_recognitation_tkinter\college_images\AdobeStock_303989091.jpeg")
        ...
        search_label = Label(search_frame, text="Search By:", font=("Times New Roman", 15, "bold"), bg="yellow", fg="black")
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_id.get() == "" or self.var_std_name.get() == "":
            ...
            try:
                ...
                #===========load prefefine data on face from frontals from opencv========
                ...
                messagebox.showinfo("Result","Generiting Data sets completed!!!!!!")
