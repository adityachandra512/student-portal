...
class Developer:
    def __init__(self, root):
        ...
        #developer info
        dep_label = Label(main_frame, text='Hello my name,aditya', font=("Times New Roman", 20, "bold"), bg="white",fg="blue")
        ...
        img2 = img2.resize((500, 400), Image.LANCZOS)
        self.photoimg2 = ImageTk.PhotoImage(img2)
        f_lbl2 = Label(main_frame, image=self.photoimg2)
        f_lbl2.place(x=0, y=210, width=500, height=400)
